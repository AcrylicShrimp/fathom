# fathom-capability-domain-brave-search

Brave Search capability-domain implementation for Fathom's `env + action` runtime model.
...
CapabilityDomain ID: `brave_search`
...
- For richer page extraction, a separate capability domain can be added later.
