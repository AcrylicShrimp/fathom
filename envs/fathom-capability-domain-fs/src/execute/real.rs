...
pub(crate) fn list(
    ...
    list::list(path, options, capability_domain_state)
}
...
pub(crate) fn read(
    ...
    read::read(path, options, capability_domain_state)
}
...
pub(crate) fn glob(
    ...
    glob::glob(path, pattern, options, capability_domain_state)
}
...
pub(crate) fn search(
    ...
    search::search(path, pattern, options, capability_domain_state)
}
